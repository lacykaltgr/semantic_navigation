...
from cf_compact.datautils import datautils
from cf_compact.datautils.geometry import relative_transformation
from cf_compact.datautils.rgbd_images import RGBDImages
from cf_compact.utils.general_utils import measure_time
...
def get_dataset(dataconfig, basedir, sequence, **kwargs):
    ...
    elif config_dict['dataset_name'].lower() in ['custom']:
        return CustomDataset(config_dict, basedir, **kwargs)
    else:
