...
from cf_compact.utils.general_utils import find_existing_image_path
from cf_compact.datautils.geometry import rotation_matrix_to_quaternion
import numpy as np
...
def orr_log_camera(intrinsics, adjusted_pose, prev_adjusted_pose, img_width, img_height, frame_idx):
    ...
    quaternion = rotation_matrix_to_quaternion(adjusted_pose[:3, :3]).tolist()
    orr.log(
        "world/camera",
        orr.Transform3D(
